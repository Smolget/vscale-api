...
describe Vscale::Domains do
  ...
  describe '#domain_id' do
    it 'calls #get with the correct url' do
      domain_id = 97
      @api.should_receive(:get).with('domains/97')
  ...
  describe '#update_domain' do
    it 'calls #patch with the correct url and params' do
      domain_id = 97
      params = { hello: :world }
      @api.should_receive(:patch).with('domains/97', params)
  ...
  describe '#remove_domain' do
    it 'calls #delete with the correct url' do
      domain_id = 97
      @api.should_receive(:delete).with('domains/97')
  ...
  describe 'Domain Records' do
    describe '#domain_records' do
      it 'calls #get with the correct url' do
        domain_id = 97
        @api.should_receive(:get).with('domains/97/records/')
    ...
    describe '#add_domain_record' do
      it 'calls #post with the correct url and params' do
        domain_id = 97
        params = { hello: :world }
        @api.should_receive(:post).with('domains/97/records/', params)
    ...
    describe '#update_domain_record' do
      it 'calls #put with the correct url and params' do
        ...
        record_id = 98
        params = { hello: :world }
        @api.should_receive(:put).with('domains/97/records/98', params)
    ...
    describe '#remove_domain_record' do
      it 'calls #delete with the correct url' do
        domain_id = 97
        record_id = 98
        @api.should_receive(:delete).with('domains/97/records/98')
    ...
    describe '#domain_record' do
      it 'calls #get with the correct url' do
        domain_id = 97
        record_id = 98
        @api.should_receive(:get).with('domains/97/records/98')
  ...
  describe 'Domain Tags' do
    ...
    describe '#domains_tag_id' do
      it 'calls #get with the correct url' do
        tag_id = 97
        @api.should_receive(:get).with('domains/tags/97')
    ...
    describe '#update_domains_tag' do
      it 'calls #put with the correct url and params' do
        tag_id = 97
        params = { hello: :world }
        @api.should_receive(:put).with('domains/tags/97', params)
    ...
    describe '#remove_domains_tag' do
      it 'calls #delete with the correct url' do
        tag_id = 97
        @api.should_receive(:delete).with('domains/tags/97')
  ...
  describe 'PTR Records' do
    ...
    describe '#domains_ptr_id' do
      it 'calls #get with the correct url' do
        ptr_id = 97
        @api.should_receive(:get).with('domains/ptr/97')
    ...
    describe '#update_ptr_id' do
      it 'calls #put with the correct url and params' do
        ptr_id = 97
        params = { hello: :world }
        @api.should_receive(:put).with('domains/ptr/97', params)
    ...
    describe '#remove_ptr_id' do
      it 'calls #delete with the correct url' do
        ptr_id = 97
        @api.should_receive(:delete).with('domains/ptr/97')
